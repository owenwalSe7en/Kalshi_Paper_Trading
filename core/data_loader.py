...
load_dotenv()
# Create API client using sandbox credentials. The kalshi_python Configuration
# helper does not accept a host parameter at initialization, so we set the
# sandbox endpoint after instantiating the object.
config = Configuration()
config.host = "https://demo-api.kalshi.com/trade-api/v2"
api = ApiInstance(
